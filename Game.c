        ...
        if(up==0&&down==1){
            if(A[r1+1][c1]==-70 && A[r1+1][c2]==-70 && A[r1+rows_c][c+1]!=-51){  // move down
               ...
               if(x){
                ...
                if(x){
                    /*printf("%d %d %d %d",r1/2,r2/2,c1/2,c2/2);sleep(2);*/
                    if(!check){  //make box in the junction
                    A[r1][c+1]=-51;
                    F[r1][c+1]=flag;
                    A[r1+1][c+1]=178;
                    F[r1+1][c+1]=flag;}
                ...
                if(x&&y){
                    ...
                    A[r1][c+1]=-51;   //make box in the junction
                    F[r1][c+1]=flag;
                    A[r1+1][c+1]=178;
                    F[r1+1][c+1]=flag;
                    return 1;
    ...
    if(c1==c2){
        ...
        if(left==0&&right==1){
            if(A[r][c1+1]==-51 && A[r+rows_c][c1+1]==-51 && A[r+1][c1+cols_c]!=-70){  //move to the right
               ...
               if(x){
                   /*printf("%d %d %d %d",r1/2,r2/2,c1/2,c2/2);sleep(2);*/
                   if(!check){ //make a box on its right
                  A[r+1][c1]=-70;
                  F[r+1][c1]=flag;
                  A[r+1][c1+1]=178;
                  F[r+1][c1+1]=flag;}
                ...
                if(x){
                    /*printf("%d %d %d %d",r1/2,r2/2,c1/2,c2/2);sleep(2);*/
                    if(!check){ //make box at the junction
                    A[r+1][c1]=-70;
                    F[r+1][c1]=flag;
                    A[r+1][c1+1]=178;
                    F[r+1][c1+1]=flag;}
            ...
            if(A[r][c1-1]==-51 && A[r+rows_c][c1-1]==-51 && A[r+1][c1-cols_c]!=-70){  //move to the left
                ...
                if(x){
                    /*printf("%d %d %d %d",r1/2,r2/2,c1/2,c2/2);sleep(2);*/
                    if(!check){  //make a box on its left
                    A[r+1][c1]=-70;
                    F[r+1][c1]=flag;
                    A[r+1][c1-1]=178;
                    F[r+1][c1-1]=flag;}
