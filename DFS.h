int check_chain(char **A,int **F,int r1,int r2,int c1, int c2,player *p1,player *p2,int right,int left,int up,int down,int check){
    ...
    if(r1==r2){
        ...
        if(up==0&&down==1){
            ...
            else if(A[r1+rows_c][c+1]!=-51 && A[r1+1][c]!=-70 && A[r1+1][c+cols_c]!=-70&&check!=2){ //moving down then find paths right and left and down
            ...
            else if(A[r1-rows_c][c+1]!=-51 && A[r1-1][c]!=-70 && A[r1-1][c+cols_c]!=-70&&check!=2){ //moving up then find paths right and left and up
                x=check_chain(A,F,r1,r2-rows_c,c,c,p1,p2,0,1,0,0,2); //call function check the left
    ...
    if(c1==c2){
        ...
        if(left==0&&right==1){
            ...
            else if(A[r][c1+1]!=-51 && A[r+rows_c][c1+1]!=-51 && A[r+1][c1+cols_c]!=-70&&check!=2){ //moving right then find paths right and up and down
            ...
            else if(A[r][c1-1]!=-51 && A[r+rows_c][c1-1]!=-51 && A[r+1][c1-cols_c]!=-70&&check!=2){ //moving left then find paths left and up and down
